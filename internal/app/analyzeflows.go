...
// once (UAT round 7: independent direction selection).
package app
...
// direction (analyzer.DirectionDst or DirectionSrc). UAT round 7: the
...
// pulls the port in once. An empty selection keeps the PAR-307 auto-pick.
...
// when each is selected (UAT round 7: independent direction selection).
